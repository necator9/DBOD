...
if __name__ == '__main__':
    ...
    cam_h = -3
    img_res = [1024, 768]
    camera_matrix = np.array([[602.17434328, 0, 511.32476428],
                               [0.0, 601.27444228, 334.8572872],
                               [0, 0, 1]])
    f_l = 2.2

    e = FeatureExtractor(r_x, cam_h, img_res, camera_matrix, f_l) 
    print(e.rev_rot_x_mtx)
    print(camera_matrix)
    print(e.rev_intrinsic_mtx)